...
std::array<double,2> ComputePosition2D(int i, int j, GridParameter input)
{
	...
	if ( i >= 1 && i <= input.I1)
	{	
		BottomPoint[0] = input.L1-input.L1*(1.0-input.beta1*( pow(((input.beta1+1.0)/(input.beta1-1.0)),(1.0-((input.I1-i))/(input.I1-1.0))) -1.0)/( pow(((input.beta1+1.0)/(input.beta1-1.0)),(1.0-((input.I1-i))/(input.I1-1.0))) +1.0));

		TopPoint[0] = input.L4-input.L4*(1.0-input.beta4*( pow(((input.beta4+1.0)/(input.beta4-1.0)),(1.0-((input.I4-i))/(input.I4-1.0))) -1.0)/( pow(((input.beta4+1.0)/(input.beta4-1.0)),(1.0-((input.I4-i))/(input.I4-1.0))) +1.0));
