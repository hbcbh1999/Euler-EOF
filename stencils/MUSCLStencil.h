...
protected:
    ...
    void ReconstructFlux(InviscidFlowField & inviscidFlowField, int i, int j);
    void ReconstructFlux(InviscidFlowField & inviscidFlowField, int i, int j, int k);

    void rotateUFGH(InviscidFlowField & inviscidFlowField, int i, int j);
    ...
    void rotateUFGH(InviscidFlowField & inviscidFlowField, int i, int j, int k);
